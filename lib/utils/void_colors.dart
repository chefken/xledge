...
class VoidColors {
  ...
  static const surfaceElevated = Color(0xFFFBFAFF);
  static const outlineVariant  = Color(0xFFF0EEF8);
  static const outline         = Color(0xFFE4E0F0);

  static const primary         = Color(0xFF6C3CE1);
  static const primaryLight    = Color(0xFFEDE8FF);
  static const primaryMid      = Color(0xFFA78BFA);
  static const primaryDark     = Color(0xFF4A1FA8);
  ...
  static const textPrimary     = Color(0xFF0C0A1E);
  static const textSecondary   = Color(0xFF6B6880);
  static const textHint        = Color(0xFFAAABBF);
  ...
  static const iconBg          = Color(0xFFF0EEF8);
  static const iconColor       = Color(0xFF3D3A55);
